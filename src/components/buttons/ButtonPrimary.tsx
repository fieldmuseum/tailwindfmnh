...
export default function ButtonPrimary() {
  return (
    <button 
      ...
      <span className='absolute bottom-0 left-0 right-0 h-0 transition-all duration-300 origin-bottom scale-x-0 transform bg-blue-700 group-hover:h-full group-hover:scale-x-100'>
      </span>
    </button>
  )
}
